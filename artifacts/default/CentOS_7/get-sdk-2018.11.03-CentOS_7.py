...
artefacts=[
  ["https://iis-artifactory.ee.ethz.ch/artifactory/release/CentOS_7/pulp/sdk/mainstream/4ab3076348e26a8c0c59743a94bd29f3d6f3862b/0/sdk.tar.bz2", "pkg/sdk/2018.11.03"],
  ["https://iis-artifactory.ee.ethz.ch/artifactory/release/CentOS_7/pulp/pulp_riscv_gcc/mainstream/1.0.7/0/pulp_riscv_gcc.tar.bz2", "pkg/pulp_riscv_gcc/1.0.7"]
]

exports=[
  ["PULP_SDK_HOME", "$PULP_PROJECT_HOME/pkg/sdk/2018.11.03"],
  ["PULP_SDK_INSTALL", "$PULP_SDK_HOME/install"],
  ["PULP_SDK_WS_INSTALL", "$PULP_SDK_HOME/install/ws"],
  ["PULP_RISCV_GCC_TOOLCHAIN_CI", "$PULP_PROJECT_HOME/pkg/pulp_riscv_gcc/1.0.7"],
