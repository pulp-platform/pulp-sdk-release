...
artefacts=[
  ["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_16/pulp/sdk/mainstream/a34ee7d69e8efe61100167bf9f3f7c8912557c40/0/sdk.tar.bz2", "pkg/sdk/2019.03.01"],
  ["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_16/pulp/pulp_riscv_gcc/mainstream/1.0.10/0/pulp_riscv_gcc.tar.bz2", "pkg/pulp_riscv_gcc/1.0.10"]
]

exports=[
  ["PULP_SDK_HOME", "$PULP_PROJECT_HOME/pkg/sdk/2019.03.01"],
  ["PULP_SDK_INSTALL", "$PULP_SDK_HOME/install"],
  ["PULP_SDK_WS_INSTALL", "$PULP_SDK_HOME/install/ws"],
  ["PULP_RISCV_GCC_TOOLCHAIN_CI", "$PULP_PROJECT_HOME/pkg/pulp_riscv_gcc/1.0.10"],
