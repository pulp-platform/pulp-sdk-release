...
artefacts=[
  ["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_16/pulp/sdk/mainstream/cbd31f5690a838c1bd27cf06710c86dac8a81eec/0/sdk.tar.bz2", "pkg/sdk/2018.05.10"],
  ["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_16/pulp/or10nv2_gcc/mainstream/2.0.15/0/or10nv2_gcc.tar.bz2", "pkg/or10nv2_gcc/2.0.15"],
  ["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_16/pulp/riscv_gcc/mainstream/2.3.16/0/riscv_gcc.tar.bz2", "pkg/riscv_gcc/2.3.16"],
  ["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_16/pulp/pulp_riscv_gcc/mainstream/1.0.4/0/pulp_riscv_gcc.tar.bz2", "pkg/pulp_riscv_gcc/1.0.4"]
]

exports=[
  ["PULP_SDK_HOME", "$PULP_PROJECT_HOME/pkg/sdk/2018.05.10"],
  ["PULP_SDK_INSTALL", "$PULP_SDK_HOME/install"],
  ["PULP_SDK_WS_INSTALL", "$PULP_SDK_HOME/install/ws"],
  ["OR10NV2_GCC_TOOLCHAIN", "$PULP_PROJECT_HOME/pkg/or10nv2_gcc/2.0.15"],
  ["RISCV_GCC_TOOLCHAIN", "$PULP_PROJECT_HOME/pkg/riscv_gcc/2.3.16"],
  ["PULP_RISCV_GCC_TOOLCHAIN_CI", "$PULP_PROJECT_HOME/pkg/pulp_riscv_gcc/1.0.4"],
...
pkg=["sdk", "cbd31f5690a838c1bd27cf06710c86dac8a81eec"]
